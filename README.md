<!-- rot13, because we keep things friendly: gur png erivrjrq guvf pbzzvg naq nccebirq abguvat -->
<div align="center">

<img src="https://raw.githubusercontent.com/Navidtor/Navidtor/main/assets/banner.svg" alt="banner" width="100%" />

### *「So what if the Heavens stand against me? I route my own packets.」*
...
|---|---|---|
| [🏛️ **Smart_University_Platform**](https://github.com/Smart-University-Management-Platform/Smart_University_Platform) | 🥇 Solo-Forged Artifact | a full university management platform — architected and built entirely by me |
| [⚙️ **OS_Project**](https://github.com/Navidtor/OS_Project) | 🔩 Forbidden C Arts | ALFS — a custom process scheduler written in C, close to the metal |
| [🦋 **CAD_Project**](https://github.com/Navidtor/CAD_Project) | 💠 Silicon Talismans | *Butterfly Escape* — a game running on a real FPGA, in pure VHDL with testbenches |
| [🗄️ **DB_Project**](https://github.com/Navidtor/DB_Project) | 📜 Data Alchemy | full-stack TypeScript/React database platform with docs and scripts |
| [🧠 **AI_Project**](https://github.com/Navidtor/AI_Project) | 🔮 Mind Refinement | AI experiments in Python — search, learning, and other mental techniques |
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/Navidtor/Navidtor/output/github-contribution-grid-snake-dark.svg" />
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/Navidtor/Navidtor/output/github-contribution-grid-snake.svg" />
